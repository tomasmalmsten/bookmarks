...
* [Git secrets](https://vimeo.com/79869209) - by Brent Beer; From pull request ref specs to patch mode, this session will examine some of the hidden features that can make git easier and more efficient to work with. For experienced git users only
